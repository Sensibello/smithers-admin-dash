<template>
  <div>
    <div class="d-flex py-3" v-if="isShowBreadcrumb && !layout.breadcrumbHide">
      <div class="d-flex">
      ...
      <div class="d-flex align-items-center flex-grow-1">
        ...
        <div style="min-width: 250px" class="ml-auto text-right text-13">
          <b-breadcrumb :items="items" class="text-secondary" />
        </div>
      </div>
    </div>
...
export default {
  ...
  computed: {
    isShowBreadcrumb() {
      return (
        this.componentMeta &&
        this.componentMeta.page &&
        this.componentMeta.page.showBreadcrumb
      );
    },
    titleBreadcrumb() {
      return (
        this.componentMeta &&
        this.componentMeta.page &&
        this.componentMeta.page.titleBreadcrumb
      );
    },
