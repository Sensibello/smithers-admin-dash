<template>
  <div
    ...
    :class="{ 'side-continuous': layout.menuContinuous }"
  >
    <header
      class="ig-main-header"
      style2="
                   position: fixed;
                   top: 0;
                   z-index: 1;
    ...
    <main id="main-content">
      <b-container
        :fluid="!layout.contentBoxed"
        class="h-100"
        :class="{
          boxed:
            layout.contextBarHide && layout.contentBoxed && isShowFixedContext,
        }"
      >
        <page-wrapper
          ...
          :isCenteredContent="
            componentMeta &&
            componentMeta.page &&
            componentMeta.page.contentCentered
          "
        >
...
export default {
  ...
  mounted() {
    ...
    this.isContextMenuHided =
      document.body.classList.contains("no-context-menu");
  ...
  computed: {
    ...
    menuWidth() {
      return this.compacted
        ? layoutSize["theme-menu-compacted-width"]
        : layoutSize["theme-menu-width"]; //'85px' : '220px'
    },
